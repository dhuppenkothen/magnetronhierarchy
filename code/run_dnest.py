...
def run_burst(filename, dnest_dir = "./", levelfilename=None, nlevels=200, nsims=100):
...
def run_all_bursts(data_dir="./", dnest_dir="./", levelfilename="test_levels.dat", nlevels=200, nsims=100):
    ...
    for f in filenames:
        ...
        run_burst(f, dnest_dir=dnest_dir, levelfilename=levelfilename, nlevels=nlevels, nsims=nsims)
...
def main():
    print("I am in main")
    run_all_bursts(data_dir, dnest_dir, levelfilename, nlevels, nsims)
    return
...
if __name__ == "__main__":
    ...
    parser.add_argument("-l", "--nlevels", action="store",dest="nlevels", required=False, default="200", help="Maximum number of levels")
    parser.add_argument("-s", "--nsims", action="store",dest="nsims", required=False, default="100", help="Number of simulations")

    clargs = parser.parse_args()
    data_dir = clargs.data_dir
    dnest_dir = clargs.dnest_dir
    nlevels = int(clargs.nlevels)
    nsims = int(clargs.nsims)
